# city in the sky Services

Static service page for `city in the sky`.
...
- PayPal payment link is available after scope confirmation.
- Crypto invoice is also available: USDT, USDC, BTC, ETH, or another supported asset.
- No wallet secrets, private keys, seed phrases, payment-card data, or customer secrets are accepted.

Public portfolio:

- https://nonggde.github.io/city-in-the-sky-services/agent-card.json
- https://github.com/nonggde/website-lead-brief-actor
- https://nonggde.github.io/city-in-the-sky-services/website-lead-briefs.html
...
This page is English-only and safe for global-facing outreach.
